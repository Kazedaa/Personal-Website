...
//       <div>
//         <Spotlight className="-top-40 -left-10 md:-left-32 md:-toop-20 h-screen" fill="white"/>
//         <Spotlight className="top-10 -left-full h-[80vh] w-[50vw]" fill="purple"/>
//         <Spotlight className="top-28 left-80 h-[80vh] w-[50vw]" fill="blue"/>
//       </div>

//       <div className="h-screen w-full dark:bg-black-100 bg-white  dark:bg-grid-white/[0.03] bg-grid-black-100/[0.2] flex items-center justify-center top-0 left-0">
