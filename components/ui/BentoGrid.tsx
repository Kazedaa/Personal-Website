...
import MagicButton from "./Magibutton";
...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText('hemangjamadagni@gmail.com');
    setcopied(true);
  }
  ...
  return (
    ...
    >
      <div className={`${id===6 && 'flex justify-center'} h-full`}>
        ...
        <div className={`absolute wight-0 -bottom-5 ${id===5 && 'w-full opacity-80'}`}>
          {spareImg && (
            <img 
            src={spareImg} 
            alt={spareImg}
        ...
        {id === 6 &&(
          <div className="mt-5 relative">
            ...
            <MagicButton title = {copied? "Email Copied!":"Copy my Email"} icon={<IoCopyOutline/>} position ="left" otherClasses="bg-[#161831]" handleClick={handleCopy}/>
          </div>
        )}
      </div>
    </div>
